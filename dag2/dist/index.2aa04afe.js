...
})({"fCe0s":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "d0e9fb4a2aa04afe";
...
},{}],"1jb3G":[function(require,module,exports) {
/*
...
*/ let naam = "Bohdan";
if (naam.length < 10) render("Het is een goede naam \uD83E\uDD18");
else if (naam.length >= 10 && naam.length <= 20) render("Het is een grote naam!");
else {
...
},{}]},["fCe0s","1jb3G"], "1jb3G", "parcelRequire09cb")

//# sourceMappingURL=index.2aa04afe.js.map
